...
const CONTACT_US_SCHEMA_DATA_SCIENCE_SERVICE = yup
  .object({
    fullName: yup
      .string()
      .trim()
    ...
    domain: yup
      ...
      .matches(/.{1,}/, {
        ...
        domain: "Domain must be at least 1 characters long",
      })
      .max(1000, "Domain must not exceed 1000 characters"),
    message: yup
      .string()
      .trim()
      .matches(/.{1,}/, {
...
export default CONTACT_US_SCHEMA_DATA_SCIENCE_SERVICE;
