...
const CONTACT_US_SCHEMA_DEVOPS_SERVICE = yup
  .object({
    fullName: yup
      .string()
      .trim()
    ...
    cloudProvider: yup
      ...
      .matches(/.{2,}/, {
        ...
        message: "Cloud provider name  must be at least 2 characters long",
      })
      .max(100, "Cloud provider name must not exceed 100 characters"),
    message: yup
      .string()
      .trim()
      .matches(/.{1,}/, {
...
export default CONTACT_US_SCHEMA_DEVOPS_SERVICE;
