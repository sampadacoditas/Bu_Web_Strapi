export const ROUTES = {
  ...
  jobDescription: "/api/v2/job-openings/get-postingTitle-details",
  servicesContactUs: "/sendCoditasServiceEnquiryMail",
...
export const baseURLStrapi = "http://localhost:1337";
